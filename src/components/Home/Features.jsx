  ...
  return (
    <section className="m-4 md:m-8 dark:bg-gray-100 dark:text-gray-800">
      <div className="container mx-auto p-4 my-6 space-y-2 text-center">
        <h2 className="text-5xl font-bold">Get A Perfect Body</h2>
      ...
      <div className="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
       ...
       <img className="h-24 w-24" src={personal} alt="" />
        ...
        <img className="h-24 w-24" src={equip} alt="" />
          <h3 className="my-3 text-3xl font-semibold">Advanced Equipment</h3>
          <div className="space-y-1 leading-tight">
            <p>
        ...
        <img className="h-24 w-24" src={group} alt="" />
          <h3 className="my-3 text-3xl font-semibold">Group Classes</h3>
          <div className="space-y-1 leading-tight">
            <p>
        ...
        <img className="h-24 w-24" src={nutrition} alt="" />
          <h3 className="my-3 text-3xl font-semibold"> Nutrition Coaching</h3>
          <div className="space-y-1 leading-tight">
            <p>
        ...
        <img className="h-24 w-24" src={community} alt="" />
          <h3 className="my-3 text-3xl font-semibold"> Community Support</h3>
          <div className="space-y-1 leading-tight">
            <p>
