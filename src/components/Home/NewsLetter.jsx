...
const NewsLetter = () => {
    ...
    const handleNewsLetter = (e) => {
        ...
        axiosPublic.post('/newsletter',newsLetterInfo)
        .then(res=> {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 className="mb-4 text-3xl sm:text-5xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">
